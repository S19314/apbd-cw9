...
*/
        ...
        public void Przyklad11()
        {
            ...
            var result = Emps.Select(emp => emp.Salary)
                             .Aggregate((summ, next) => summ + next);
                             */
            // Console.WriteLine("Pracownik z najwyższą pensją  " + result);
            
            
            var res = Emps.Aggregate((max, next) =>  max.Salary < next.Salary ? next : max);
            Console.WriteLine("Pracownik " + res + ", salary " + res.Salary);
        }
        ...
        public void Przyklad12()
        {
            ...
            for (int i = 0; i < res.Count(); i++) 
            {
                Console.WriteLine(res.ElementAt(i).Deptno + " " + res.ElementAt(i).Dname + " " + res.ElementAt(i).empToString);    
            }
        }
    }
}
